...
const logoImage = navbarSection.querySelector('img[src="/images/logoflat_whiteC.png"]'); 
const downArrowImages = navbarSection.querySelectorAll('img[src="images/down_arrow.svg"]');
